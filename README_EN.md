...
- [x] Multilingual switching & automatic system theme matching
- [x] Bottom-mounted expand trigger with top-anchored dropdown animation
- [x] Interface-free Ctrl+Shift+1~9 clipboard shortcuts with global toggle
